  ...
  if (!empty($_SESSION)) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
      ...
      if (mysqli_num_rows($resultData) > 0) {
            ...
            $dataUsers['username'] = strtolower($dataArray['username']);
            $dataUsers['password'] = md5($dataArray['password']);
            $dataUsers['email'] = $dataArray['email'];
            $dataUsers['level'] = 1;
            $result = $db->insert("users", $dataUsers);

            $dataBio['fullname'] = $dataArray['fullname'];
            $dataBio['whatsapp'] = strval($_POST['phone']);
            $dataBio['user_id'] = $result['last_id'];
            $result2 = $db->insert("biodata", $dataBio);
            $notif = "<small style='color: green; text-align:center;'>Registration berhasil, silahkan <b><a style='text-decoration: underline;' href='index.php'>login</a></b>!</small>";
      }
    }
  }
?>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="form-group">
                        ...
                        <input autocomplate="off" required name="phone" class="form-control" type="text" placeholder="No HP">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
